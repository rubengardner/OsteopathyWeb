...
## 1.1. User targets
The following users types can be benefited from the website:
...
![color contrast 1](assets/images/contrast_check.png)
![color contrast 2](assets/images/contrast_check2.png)
...
- useful for the user to navigate around the site
...
- Ueful for quick acces to the booking page
...
## Techniques section
- The left side contains the differnet techniques a patient should expect to experience during his time at the clinic.
...
Index page html validation screenshot:
  ![Html validation 1](./assets/images/html_val_index.png)

Services page html validation screenshot:
  ![Html validation 2](./assets/images/html_val_services.png)

Booking page html validation screenshot:
  ![Html validation 3](./assets/images/html_val_booking.png)
...
Css style sheet validation screenshot:
  ![Css validation ](./assets/images/css_validator.png)

## 4.2. Manual testing

I have tested my site manually on two devices. These include:
  - Galaxy S5 (360 x 640)
...
![Index-html page accessibility](./assets/images/index_lighthouse.png)
...
![Services-html page accessibility](./assets/images/services_lighthouse.png)
...
![Booking-html page accessibility](./assets/images/booking_lighthouse.png)
